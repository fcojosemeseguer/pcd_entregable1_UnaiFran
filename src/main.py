...
from usuarios.usuario import Comandante, Opeario
...
repuesto1 = Repuesto("Cristal de Kyber", "Techno Industrial", 15, 1500.0)

repuesto2 = Repuesto("Bobina Hiperdrive", "Corporación Estelar", 8, 3000.0)

repuesto3 = Repuesto("Regulador Energético", "SolidState Systems", 25, 800.0)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if opcion == "1":
            ...
            limpiar_pantalla()
            print("\n👋 ¡Hasta luego! Abandonando el sistema...")
            break
        else:
            print("❌ Opción inválida. Intente de nuevo.")
            import time
